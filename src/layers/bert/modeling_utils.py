...
class PreTrainedModel(nn.Module):
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *model_args, **kwargs):
        ...
        # Set model in evaluation mode to dis-activate DropOut modules by default
        model.eval()
    ...
    def _generate_no_beam_search(
        ...
        while cur_len < max_length:
            model_inputs = self.prepare_inputs_for_generation(input_ids, past=past)
            # model_inputs = self.prepare_inputs_for_generation(input_ids, past=None)

            # logging.info('floping')
            # del model_inputs['is_training']
            # del model_inputs['encoder_history_states']
            # from src.tools.torch_common import count_flops
